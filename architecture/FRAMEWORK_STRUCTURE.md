...
**文档生成时间**: 2026-04-18（更新）
**框架版本**: fund-catering-consume 1.0-SNAPSHOT
**注意**: 当前项目正在从单体向微服务转型，核心交易引擎仍在 fund-catering-consume 中。新增的系统管理功能已迁移到 system-service 等微服务中。详见 [MODULE_MICROSERVICES.md](../modules/MODULE_MICROSERVICES.md)
